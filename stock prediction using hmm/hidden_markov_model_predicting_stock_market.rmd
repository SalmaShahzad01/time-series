---
title: "Hidden Markov Model-Predicting Stock Market Behavior"
output:
  html_document:
...
This kernel  is inspired from Manuel Amunategui. - [Here](http://amunategui.github.io/markov-chains/index.html)
...
dj <- read.csv("upload_DJIA_table.csv")
